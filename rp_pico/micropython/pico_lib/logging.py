# 2022-08-15
# # Copied from https://github.com/pfalcon/pycopy-lib/tree/master/logging/logging/__init__.py
# and replace method:
#        def flush(self):
#             self._stream.flush()
# with:
#        def flush(self):
#            if hasattr(self._stream, "flush"): # RP2 has no flush() method
#                self._stream.flush()
#
# Don't use https://github.com/micropython/micropython-lib/blob/master/python-stdlib/logging/logging.py,
# it is too limited.
